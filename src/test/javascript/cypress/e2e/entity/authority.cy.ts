...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '53cf38ef-3f55-4f4f-b19a-d5daa3a2a1cc' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9440913a-abbc-4cd6-ab32-d26f1e767be7');
      cy.get(`[data-cy="name"]`).should('have.value', '9440913a-abbc-4cd6-ab32-d26f1e767be7');
