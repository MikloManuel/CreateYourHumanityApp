...
import space.createyourhumanity.app.security.oauth2.AudienceValidator;
import space.createyourhumanity.app.security.oauth2.CustomClaimConverter;
import space.createyourhumanity.app.web.filter.SpaWebFilter;
            ...
            .csrf(
                csrf ->
                    csrf
                        ...
                        .ignoringRequestMatchers(antMatcher("/websocket/**"))
            )
                ...
                headers ->
                    headers
                        ...
                        .permissionsPolicy(
                            permissions ->
                                permissions.policy(
                                    "camera=(), fullscreen=(self), geolocation=(), gyroscope=(), magnetometer=(), microphone=(), midi=(), payment=(), sync-xhr=(self)"
                                )
                        )
            )
