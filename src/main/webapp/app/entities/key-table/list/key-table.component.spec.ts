...
import { sampleWithRequiredData } from '../key-table.test-samples';
...
describe('KeyTable Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to keyTableService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getKeyTableIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getKeyTableIdentifier).toHaveBeenCalledWith(entity);
