...
import { sampleWithRequiredData } from '../privacy-settings.test-samples';
...
describe('PrivacySettings Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PrivacySettingsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.privacySettings?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to privacySettingsService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getPrivacySettingsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPrivacySettingsIdentifier).toHaveBeenCalledWith(entity);
