...
import { sampleWithRequiredData } from '../formula-data.test-samples';
...
describe('FormulaData Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to formulaDataService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getFormulaDataIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFormulaDataIdentifier).toHaveBeenCalledWith(entity);
