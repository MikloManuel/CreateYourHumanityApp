...
import { sampleWithRequiredData } from '../user-mindmap.test-samples';
...
describe('UserMindmap Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to userMindmapService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getUserMindmapIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUserMindmapIdentifier).toHaveBeenCalledWith(entity);
